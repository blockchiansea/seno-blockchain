...
get_bladebit_url() {
  ...
  GITHUB_BASE_URL="https://github.com/Seno-Network/bladebit/releases/download"
...
get_madmax_filename() {
  ...
  echo "${SENO_PLOT}-${MADMAX_VER}-${SUFFIX}"
}
...
get_madmax_url() {
  ...
  GITHUB_BASE_URL="https://github.com/Seno-Network/seno-plotter-madmax/releases/download"
