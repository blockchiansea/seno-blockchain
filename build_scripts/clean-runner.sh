...
rm -rf ../venv || true
rm -rf venv || true
rm -rf seno_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf seno-blockchain-gui/build || true
rm -rf seno-blockchain-gui/daemon || true
rm -rf seno-blockchain-gui/node_modules || true
rm seno-blockchain-gui/temp.json || true
( cd "$PWD/seno-blockchain-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
