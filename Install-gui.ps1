...
{
    Write-Output "This script requires that the Seno Python virtual environment is activated."
...
Push-Location
try {
    Set-Location seno-blockchain-gui
    ...
    Write-Output ""
    Write-Output "Seno blockchain Install-gui.ps1 completed."
    Write-Output ""
    Write-Output "Type 'cd seno-blockchain-gui' and then 'npm run electron' to start the GUI."
} finally {
    Pop-Location
}
