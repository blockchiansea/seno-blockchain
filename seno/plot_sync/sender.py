...
from seno.plot_sync.exceptions import AlreadyStartedError, InvalidConnectionTypeError
from seno.plot_sync.util import Constants
from seno.plotting.manager import PlotManager
from seno.plotting.util import PlotInfo
...
from seno.server.ws_connection import NodeType, ProtocolMessageTypes, WSSenoConnection, make_msg
from seno.util.generator_tools import list_to_batches
from seno.util.ints import int16, uint32, uint64
...
class Sender:
    ...
    _connection: Optional[WSSenoConnection]
    _sync_id: uint64
    ...
    def set_connection(self, connection: WSSenoConnection) -> None:
