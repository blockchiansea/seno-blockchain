...
from seno.plot_sync.delta import Delta, PathListDelta, PlotListDelta
from seno.plot_sync.exceptions import (
...
from seno.plot_sync.util import ErrorCodes, State, T_PlotSyncMessage
...
from seno.server.ws_connection import ProtocolMessageTypes, WSSenoConnection, make_msg
from seno.types.blockchain_format.sized_bytes import bytes32
from seno.util.ints import int16, uint32, uint64
from seno.util.misc import get_list_or_len
...
class Receiver:
    ...
    def connection(self) -> WSSenoConnection:
