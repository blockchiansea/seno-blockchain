...
from seno.harvester.harvester import Harvester
from seno.plotting.util import PlotInfo, parse_plot_info
from seno.protocols import harvester_protocol
from seno.protocols.farmer_protocol import FarmingInfo
from seno.protocols.harvester_protocol import Plot, PlotSyncResponse
from seno.protocols.protocol_message_types import ProtocolMessageTypes
from seno.server.outbound_message import make_msg
...
from seno.util.ints import uint8, uint32, uint64
from seno.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def harvester_handshake(
        self, harvester_handshake: harvester_protocol.HarvesterHandshake, peer: WSSenoConnection
    ):
        """
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSSenoConnection
    ):
        """
