"""
NOTE: This contains duplicate code from `seno.cmds.plots`.
After `seno plots create` becomes obsolete, consider removing it from there.
"""
import asyncio
import logging
...
def get_chiapos_install_info() -> Optional[Dict[str, Any]]:
    ...
    return {"display_name": "Seno Proof of Space", "version": chiapos_version, "installed": True}
