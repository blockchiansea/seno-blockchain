...
from seno.consensus.pot_iterations import calculate_sp_iters, is_overflow_block
...
from seno.timelord.iters_from_block import iters_from_block
from seno.timelord.timelord_state import LastState
from seno.timelord.types import Chain, IterationType, StateType
from seno.types.blockchain_format.classgroup import ClassgroupElement
from seno.types.blockchain_format.reward_chain_block import RewardChainBlock
...
from seno.util.config import process_config_start_method
...
class Timelord:
    ...
    def __init__(self, root_path, config: Dict, constants: ConsensusConstants):
        ...
        self._server: Optional[SenoServer] = None
    ...
    async def on_connect(self, connection: ws.WSSenoConnection):
        pass
