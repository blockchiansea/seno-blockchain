...
from seno.plotting.util import parse_plot_info
...
from seno.util.misc import VersionedBlob
        ...
        try:
            ...
            if stored_cache.version == CURRENT_VERSION:
                ...
                for path, cache_entry in cache_data.entries:
                    ...
                    #       Related: - https://github.com/denisio/seno-blockchain/issues/13084
                    ...
                    # See https://github.com/seno/chiapos/blob/3ee062b86315823dd775453ad320b8be892c7df3/src/prover_disk.hpp#L282-L287  # noqa: E501
