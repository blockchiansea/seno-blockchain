...
from seno.data_layer.data_layer_wallet import Mirror, SingletonRecord
from seno.pools.pool_wallet_info import PoolWalletInfo
from seno.rpc.rpc_client import RpcClient
...
from seno.wallet.transaction_sorting import SortKey
...
class WalletRpcClient(RpcClient):
    """
    Client to Seno RPC, connects to a local wallet. Uses HTTP/JSON, and converts back from
    JSON into native python objects before returning. All api calls use POST requests.
    Note that this is not the same as the peer protocol, or wallet protocol (which run Seno's
    ...
    async def nft_mint_bulk(
        ...
        xse_coins: Optional[List[Dict]] = None,
        xse_change_target: Optional[str] = None,
        ...
        request = {
            ...
            "xse_coins": xse_coins,
            "xse_change_target": xse_change_target,
