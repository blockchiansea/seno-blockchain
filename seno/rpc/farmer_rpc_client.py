...
from seno.rpc.farmer_rpc_api import PlotInfoRequestData, PlotPathRequestData
from seno.rpc.rpc_client import RpcClient
from seno.types.blockchain_format.sized_bytes import bytes32
from seno.util.misc import dataclass_to_json_dict


class FarmerRpcClient(RpcClient):
    """
    Client to Seno RPC, connects to a local farmer. Uses HTTP/JSON, and converts back from
