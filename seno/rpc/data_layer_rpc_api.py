...
from seno.data_layer.data_layer_wallet import DataLayerWallet, Mirror, verify_offer
from seno.rpc.data_layer_rpc_util import marshal
...
from seno.util.streamable import recurse_jsonify
...
class DataLayerRpcApi:
    ...
    def __init__(self, data_layer: DataLayer):  # , wallet: DataLayerWallet):
        ...
        self.service_name = "seno_data_layer"
