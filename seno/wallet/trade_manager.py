...
from seno.wallet.db_wallet.db_wallet_puzzles import ACS_MU_PH
...
from seno.wallet.trading.trade_store import TradeStore
...
class TradeManager:
    ...
    Puzzle Drivers:
      - See seno/wallet/outer_puzzles.py for a full description of how to build these
    ...
    async def coins_of_interest_farmed(
        self, coin_state: CoinState, fork_height: Optional[uint32], peer: WSSenoConnection
    ) -> None:
        """
    ...
    async def check_offer_validity(self, offer: Offer, peer: WSSenoConnection) -> bool:
