...
from seno.data_layer.data_layer_errors import KeyNotFoundError
from seno.data_layer.data_layer_util import (
    DiffData,
    InternalNode,
    KeyValue,
    Layer,
...
from seno.data_layer.data_layer_wallet import DataLayerWallet, Mirror, SingletonRecord, verify_offer
from seno.data_layer.data_store import DataStore
from seno.data_layer.download_data import insert_from_delta_file, write_files_for_root
...
from seno.wallet.trading.offer import Offer as TradingOffer
...
class DataLayer:
    ...
    async def on_connect(self, connection: WSSenoConnection) -> None:
        pass
