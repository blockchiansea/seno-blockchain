...
from seno.cmds.show_funcs import show_async
...
def show_cmd(
    ...
    if connections:
        print("'seno show -c' has been renamed to 'seno peer -c' ")
    if add_connection != "":
        print("'seno show -a' has been renamed to 'seno peer -a' ")
    if remove_connection != "":
        print("'seno show -r' has been renamed to 'seno peer -r' ")
    if wallet_rpc_port is not None:
        print("'seno show -wp' is not used, please remove it from your command.")
    asyncio.run(
        show_async(
            rpc_port,
            ctx.obj["root_path"],
