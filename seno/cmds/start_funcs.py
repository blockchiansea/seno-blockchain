...
from seno.cmds.keys_funcs import migrate_keys
from seno.cmds.passphrase_funcs import get_current_passphrase
from seno.daemon.client import DaemonProxy, connect_to_daemon_and_validate
from seno.util.errors import KeychainMaxUnlockAttempts
from seno.util.keychain import Keychain
from seno.util.service_groups import services_for_groups
...
async def async_start(
    ...
    if daemon is None:
        print("Failed to create the seno daemon")
        return None
