...
from seno.util.config import load_defaults_for_missing_services, lock_and_load_config, save_config, str2bool
    ...
    with lock_and_load_config(root_path, config_yaml, fill_missing_services=True) as config:
        ...
        if testnet:
            if testnet == "true" or testnet == "t":
                ...
                testnet_port = "19444"
                testnet_introducer = "introducer-testnet10.seno.uno"
                testnet_dns_introducer = "dns-introducer-testnet10.seno.uno"
                bootstrap_peers = ["testnet10-node.seno.uno"]
                testnet = "testnet10"
                ...
                mainnet_port = "18444"
                mainnet_introducer = "introducer.seno.uno"
                mainnet_dns_introducer = "dns-introducer.seno.uno"
                bootstrap_peers = ["node.seno.uno"]
                net = "mainnet"
        ...
        if change_made:
            print("Restart any running seno services for changes to take effect")
