...
from seno.consensus.full_block_to_block_record import header_block_to_sub_block_record
...
from seno.types.blockchain_format.slots import ChallengeChainSubSlot, RewardChainSubSlot
...
from seno.types.weight_proof import (
...
def _create_shutdown_file() -> IO:
    return tempfile.NamedTemporaryFile(prefix="seno_full_node_weight_proof_handler_executor_shutdown_trigger")
