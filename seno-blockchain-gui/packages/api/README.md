...
![Alt text](https://www.seno.top/img/seno_logo.svg)

This library provides support for TypeScript/JavaScript [Seno](https://www.seno.top) apps to access the [Seno Blockchain RPC](https://github.com/Seno-Network/seno-blockchain/wiki/RPC-Interfaces), by making it easier to perform the following actions:

- Making requests to the Seno Blockchain RPC.
...
```ts
import Client, { Wallet } from '@seno/api';
