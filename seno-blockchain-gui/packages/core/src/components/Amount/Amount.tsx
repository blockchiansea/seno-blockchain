...
import senoToMojo from '../../utils/senoToMojo';
...
export default function Amount(props: AmountProps) {
  ...
  const isSenoCurrency = ['XSE', 'TXSE'].includes(currencyCode);
  const mojo = isSenoCurrency
    ? senoToMojo(correctedValue)
    ...
    <FormControl variant={variant} fullWidth={fullWidth}>
      <TextField
        ...
        InputProps={{
          ...
          inputProps: {
            decimalScale: isSenoCurrency ? 12 : 3,
            'data-testid': dataTestid,
          },
          endAdornment: (
