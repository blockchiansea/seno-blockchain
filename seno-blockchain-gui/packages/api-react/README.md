...
This library provides react hooks on the top of @seno/api and uses [RTK Query](https://redux-toolkit.js.org/rtk-query/overview) under do hood.
...
- Automatically refresh queries when data changed (using events from Seno Blockchain).
...
import { useGetPublicKeysQuery } from '@seno/api-react';
...
import { store, api } from '@seno/api-react';
