...
describe('units', () => {
  describe('#getUnit', () => {
    ...
    it('gets unit of seno using alias', () => {
  ...
  describe('#getDisplay', () => {
    it('gets display of seno', () => {
      const result = units.getDisplay('seno');
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('seno', 9);

      const result = units.getUnit('seno');

      expect(result).toEqual(9);

      units.setUnit('seno', 1);
    });
  });
  describe('#setDisplay', () => {
