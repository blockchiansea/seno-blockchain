...
import senoEnvironment from '../util/senoEnvironment';
import { setUserDataDir } from '../util/userData';
import { i18n } from '../config/locales';
import About from '../components/about/About';
import packageJson from '../../package.json';
import AppIcon from '../assets/img/seno64x64.png';
...
// Set the userData directory to its location within SENO_ROOT/gui
setUserDataDir();
...
if (!handleSquirrelEvent()) {
  ...
  const ensureCorrectEnvironment = () => {
    ...
    if (!senoEnvironment.guessPackaged() && !('VIRTUAL_ENV' in process.env)) {
      app.quit();
      return false;
    }
  ...
  if (ensureSingleInstance() && ensureCorrectEnvironment()) {
    ...
    const createWindow = async () => {
      if (manageDaemonLifetime(NET)) {
        senoEnvironment.startSenoDaemon();
      }
  ...
  const getMenuTemplate = () => {
    const template = [
      ...
      },
      {
        ...
        submenu: [
          {
            label: i18n._(/* i18n */ { id: 'Seno Blockchain Wiki' }),
            click: () => {
              openExternal(
                'https://github.com/Seno-Network/seno-blockchain/wiki',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/Seno-Network/seno-blockchain/wiki/FAQ',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/Seno-Network/seno-blockchain/releases',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/Seno-Network/seno-blockchain/blob/main/CONTRIBUTING.md',
              );
            },
          },
          {
          ...
          },
          {
            ...
            click: () => {
              openExternal(
                'https://github.com/Seno-Network/seno-blockchain/issues',
              );
            },
          },
          {
            ...
            click: () => {
              openExternal('https://keybase.io/team/seno_network.public');
            },
          },
          {
            label: i18n._(/* i18n */ { id: 'Follow on Twitter' }),
            click: () => {
              openExternal('https://twitter.com/seno_project');
            },
          },
        ],
      },
    ...
    if (process.platform === 'darwin') {
      // Seno Blockchain menu (Mac)
      template.unshift({
        label: i18n._(/* i18n */ { id: 'Seno' }),
        submenu: [
          {
            label: i18n._(/* i18n */ { id: 'About Seno Blockchain' }),
            click: () => {
              openAbout();
            },
          },
