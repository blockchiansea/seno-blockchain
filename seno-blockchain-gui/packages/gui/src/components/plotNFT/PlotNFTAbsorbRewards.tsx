...
import { usePwAbsorbRewardsMutation, useGetPlotNFTsQuery, useGetCurrentAddressQuery } from '@seno/api-react'
          ...
          >
            <Typography variant="subtitle1">
              <Trans>
                You will recieve{' '}
                <UnitFormat
                  value={mojoToSenoLocaleString(balance)}
                  display="inline"
                  state={State.SUCCESS}
                />{' '}
                to {address}
