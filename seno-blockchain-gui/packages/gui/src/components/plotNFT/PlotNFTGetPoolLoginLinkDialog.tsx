...
import { Button, CopyToClipboard, Flex, Link, Loading } from '@seno/core';
import {
  Alert,
  Dialog,
  DialogActions,
...
import { useGetPoolLoginLinkQuery } from '@seno/api-react';
import type { PlotNFT, PlotNFTExternal } from '@seno/api';
          ...
          {isLoading ? (
            ...
            <Flex flexDirection="column" gap={2}>
              ...
              <Typography variant="body2" color="textSecondary">
                ...
                <Link
                  target="_blank"
                  href="https://github.com/Seno-Network/pool-reference/blob/main/SPECIFICATION.md#get-login"
                  noWrap
                >
