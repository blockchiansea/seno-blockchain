...
import { Tokens } from '@seno/icons';
import { Flex, Loading, catToMojo, mojoToCATLocaleString } from '@seno/core';
import { WalletType } from '@seno/api';
import type { Wallet } from '@seno/api';
import { useGetWalletsQuery } from '@seno/api-react';
...
export default function OfferBuilderTokensSection(
  ...
  return (
    <OfferBuilderSection
      ...
      subtitle={
        <Trans>Seno Asset Tokens (CATs) are tokens built on top of XSE</Trans>
      }
