...
import { Wallet, WalletType, type CATToken } from '@seno/api';
import { useGetCatListQuery, useGetWalletsQuery } from '@seno/api-react';
import { Trans } from '@lingui/macro';
import { FormControl, InputLabel, MenuItem } from '@mui/material';
import { Select, useCurrencyCode } from '@seno/core';
