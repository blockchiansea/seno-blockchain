...
import type { NFTInfo, Wallet } from '@seno/api';
import {
...
/*       An NFT offer consists of a single NFT being offered for XSE/CAT      */
/* ========================================================================== */
    ...
    if (
      ...
      switch (tokenWalletInfo.walletType) {
        case WalletType.STANDARD_WALLET:
          balanceString = mojoToSenoLocaleString(
            walletBalance.spendableBalance,
            locale,
          );
          balance = mojoToSeno(walletBalance.spendableBalance);
          break;
        case WalletType.CAT:
...
/* ========================================================================== */
/*                              NFT Offer Editor                              */
/*           Currently only supports a single NFT <--> XSE/CAT offer          */
/* ========================================================================== */
