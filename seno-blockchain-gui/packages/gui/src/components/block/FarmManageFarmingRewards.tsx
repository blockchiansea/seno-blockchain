...
import { Button, Flex, Form, TextField, Loading } from '@seno/core';
import { useSetRewardTargetsMutation, useGetRewardTargetsQuery } from '@seno/api-react';
import {
  Alert,
  Dialog,
  DialogActions,
              ...
              <>
                ...
                <Typography variant="body2" color="textSecondary">
                  <Trans>
                    ...
                    0.25XSE reward for pooling plots.
                  </Trans>
                </Typography>
              </>
            )}
