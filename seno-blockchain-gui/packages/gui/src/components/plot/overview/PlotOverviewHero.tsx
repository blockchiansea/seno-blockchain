...
import { useRefreshPlotsMutation } from '@seno/api-react';
import { Grid, Typography, Divider } from '@mui/material';
import { Button, CardHero, Flex, Link, useOpenDialog } from '@seno/core';
import { Plots } from '@seno/icons';
        ...
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              ...
              <Link
                target="_blank"
                href="https://github.com/Seno-Network/seno-blockchain/wiki/Network-Architecture"
              >
                Learn more
              </Link>
            </Trans>
