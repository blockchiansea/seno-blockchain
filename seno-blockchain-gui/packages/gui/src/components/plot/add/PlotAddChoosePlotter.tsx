...
import { CardStep, Select, StateColor } from '@seno/core';
import { useGetPlottersQuery } from '@seno/api-react';
import {
  FormControl,
  FormHelperText,
  Grid,
...
import { defaultPlotter, PlotterName } from '@seno/api';
import type { Plotter, PlotterMap } from '@seno/api';
...
export default function PlotAddChoosePlotter(props: Props) {
  ...
  function displayablePlotters(plotters: PlotterMap<PlotterName, Plotter>): PlotterName[] {
    ...
    displayablePlotters.sort((a, b) => a == PlotterName.SENOPOS ? -1 : a.localeCompare(b));
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
            ...
            produces plots faster than the default Seno Proof of Space plotter. If unsure,
            use the default Seno Proof of Space plotter.
        </Trans>
      </Typography>
