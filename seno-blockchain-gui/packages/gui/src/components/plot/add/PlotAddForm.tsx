...
import { defaultPlotter, toBech32m, fromBech32m } from '@seno/api';
import {
  useStartPlottingMutation,
  useCreateNewPoolWalletMutation,
} from '@seno/api-react';
import { useForm, SubmitHandler } from 'react-hook-form';
import { Back, useShowError, ButtonLoading, Flex, Form } from '@seno/core';
...
export default function PlotAddForm(props: Props) {
  ...
  const methods = useForm<FormData>({
    defaultValues: defaultsForPlotter(PlotterName.SENOPOS),
  });
