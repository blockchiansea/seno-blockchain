...
import { senoToMojo, AlertDialog, Amount, Fee, Back, ButtonLoading, Card, Flex, Form } from '@seno/core';
  ...
  async function handleSubmit(values: CreateCATWalletData) {
    try {
      ...
      */
      ...
      const amountMojos = senoToMojo(amount || '0');
  ...
  return (
    <Form methods={methods} onSubmit={handleSubmit}>
      <Flex flexDirection="column" gap={3}>
        <Back variant="h5">
          <Trans>Create New Seno Asset Token Wallet</Trans>
        </Back>
        <Card>
