...
import { Back, Flex, Loading, useShowError } from '@seno/core';
import { useGetWalletsQuery, useAddCATTokenMutation, useGetCatListQuery } from '@seno/api-react';
import WalletCreateCard from '../create/WalletCreateCard';
import isCATWalletPresent from '../../utils/isCATWalletPresent';
import type { CATToken } from '@seno/api';
import useWalletState from '../../hooks/useWalletState';
import { SyncingStatus } from '@seno/api';
