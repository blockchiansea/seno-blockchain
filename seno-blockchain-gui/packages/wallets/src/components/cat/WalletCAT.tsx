...
import { Flex, Loading, MenuItem, useOpenDialog } from '@seno/core';
...
import { useSetCATNameMutation, useGetCatListQuery } from '@seno/api-react';
import { Offers as OffersIcon } from '@seno/icons';
